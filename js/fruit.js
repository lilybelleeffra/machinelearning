...
let confidence = 0.0;
let classifier;
let modelURL = 'https://teachablemachine.withgoogle.com/models/HU-zJ2xl8/';
let popupImg

// STEP 1: Load the model!
function preload() {
  classifier = ml5.imageClassifier(modelURL + 'model.json');
  popupImg = loadImage("grass.png");
}
...
function draw() {
  ...
  if (label == "banana" && confidence > 0.7) {
  ...
  text("what is my least favorite fruit?", width/ 2, 50);
}
